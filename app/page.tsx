    ...
    <>
      ...
      <div className="bg-[#1A0A00] text-white text-center text-xs md:text-sm py-2 px-4 font-medium">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="underline hover:text-[#E8732A] transition-colors"
        >
          pedir agora →
        </a>
      </div>
        ...
        <section className="bg-gradient-to-br from-[#1A0A00] to-[#3B1F0A] text-white pt-16 pb-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-black leading-tight mb-6">
              Snack Proteico de Verdade:<br />
              <span className="text-[#E8732A]">12 a 18g por porção</span>,<br className="md:hidden" /> Sem Lactose, Sem Retrogosto
            </h1>
            <p className="text-[#D4B8A0] text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-8">
              O Crispy Wise é a linha de snacks proteicos com mais proteína por porção do Brasil.
              Bolinhas crocantes em 5+ sabores — veganos, sem glúten e com clean label.
              Para quem quer proteína sem ter que virar atleta.
            </p>
